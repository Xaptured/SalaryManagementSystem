...
public class StringConstants {
	...
	public static final String INVALID_ADMIN = "invalid admin";
	public static final String ADMIN_NOT_FOUND = "admin not found";
	public static final String VALID_EMPLOYEE = "valid employee";
	...
	public static final String PROGRAMMER_ANALYST = "programmer analyst";
